...
Todos los objetos AL (tablas, páginas, codeunits, informes, entre otros) deben comenzar con el prefijo `VOG`.
...
los campos en extensiones de tablas deben comenzar con el prefijo `VOG`.
...
<Aside type="note">
  El nombre del archivo debe coincidir exactamente con el nombre del objeto definido dentro del archivo de código AL, excluyendo la extensión del archivo (.al).
</Aside>
