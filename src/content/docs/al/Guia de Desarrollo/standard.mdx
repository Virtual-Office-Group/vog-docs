...
#### Descripción de campos en tablas
...
<Aside type="note">
   La estructura del proyecto se definirá mediante una [plantilla general](https://github.com/Virtual-Office-Group/ProyectosAL) de GitHub al iniciar cualquier nuevo desarrollo en AL
</Aside>

<Aside type="note">
   Se puede conseguir la configuración de analizadores de codigo en los archivos (`AppSourceCop.json` y `vscode/setting.json`s) en la [plantilla general](https://github.com/Virtual-Office-Group/ProyectosAL)
</Aside>
...
<Aside type="note">
Los comentarios xml se utilizarán exclusivamente para Procedimientos, Integration Events y Business Events. Esto permite que el IntelliSense y la documentación automática generen metadatos útiles.

Para cualquier otro caso, como lógica dentro de funciones, declaraciones de variables, triggers de página o definiciones de tablas, utilizaré comentarios de una sola línea. `//`
</Aside>
...
```
<Aside type="caution">
    Los comentarios de los marcadores de posición en las variables `Label` deben estar en `español`
</Aside>
